...
subtest 'acceptance children clear inherited warn mode' => sub {
    ...
    my $cpan = $source{'dev/tools/run_phase36_cpan_acceptance.pl'};
    like($cpan,
...
subtest 'CPAN evidence seals the unset contract' => sub {
    ...
    my $manifest = $source{'dev/tools/check_phase36_acceptance_manifest.pl'};
