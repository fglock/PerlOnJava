...
sub fixture {
    my $tmp = abs_path(tempdir('phase36-authority-collision-XXXXXX',
        TMPDIR => 1, CLEANUP => 1));
...
print {\$jar_fh} "phase36 collision jar\\n\$commit\\n"; close \$jar_fh;
...
sub invoke {
    ...
    if ($pid == 0) {
        $ENV{PHASE36_MAKE_EVIDENCE_FAILPOINT} =
