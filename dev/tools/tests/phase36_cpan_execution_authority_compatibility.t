...
my $fixture = File::Spec->catfile($root, 'dev', 'tools', 'tests',
    'prepare_phase36_cpan_launch_manifest_security.t');
...
my $cpan_runner = File::Spec->catfile($root, 'dev', 'tools',
...
my $copy = File::Spec->catfile($temporary,
    'phase36_cpan_execution_authority_fixture.t');
