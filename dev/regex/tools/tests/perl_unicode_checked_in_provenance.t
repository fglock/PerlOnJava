...
my $tools_root = File::Spec->catdir($root, 'dev', 'regex', 'tools');
...
make_path($explicit_unicode, File::Spec->catdir($explicit_repo, 'dev', 'regex', 'tools'));
...
sub write_manifest {
    ...
    my $path = File::Spec->catfile(
        $repo_root, 'dev', 'regex', 'tools', 'perl_unicode_data_generators.json');
