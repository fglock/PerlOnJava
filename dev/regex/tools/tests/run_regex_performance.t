...
my $jar = $ENV{REGEX_IMPLEMENTATION_JAR_SHA256};
my $source = $ENV{REGEX_IMPLEMENTATION_SOURCE_COMMIT};
...
my $line = "REGEX_IMPLEMENTATION_REGEX_PERFORMANCE elapsed_seconds=$elapsed throughput=$throughput";
