...
#
# Usage:
#   perl dev/modules/run_exiftool_tests.pl [OPTIONS] [test_file ...]
#
# Examples:
#   perl dev/modules/run_exiftool_tests.pl                    # run all tests
#   perl dev/modules/run_exiftool_tests.pl t/Writer.t t/XMP.t # run specific tests
#   perl dev/modules/run_exiftool_tests.pl --jobs 4 --timeout 120
#   perl dev/modules/run_exiftool_tests.pl --compare          # compare with system perl
