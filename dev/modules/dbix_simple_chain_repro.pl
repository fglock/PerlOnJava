...
# Run: timeout 120 ./jperl dev/modules/dbix_simple_chain_repro.pl
# (Bundled JDBC fork lives in jar:PERL5LIB unless ~/.perlonjava/lib shadows it.)
# Optional workspace edit cycle: ./jperl -I"$PWD/src/main/perl/lib" dev/modules/dbix_simple_chain_repro.pl
