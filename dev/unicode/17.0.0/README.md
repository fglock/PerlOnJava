...
reproduce PerlOnJava's checked-in Block, Decomposition_Type, and Numeric_Value
Java data from a clean repository checkout.

The six payload files are populated byte-for-byte by the explicit import rows
