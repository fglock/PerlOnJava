...
They are copied to `$PERLONJAVA_HOME/cpan/prefs/` (defaulting to
`~/.perlonjava/cpan/prefs/`) by `CPAN::Config::_bootstrap_prefs` when CPAN
loads. See [dev/design/patch-and-cpan-prefs-layout.md](../../../../../../dev/design/patch-and-cpan-prefs-layout.md).
