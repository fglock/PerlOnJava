...
sub _bootstrap_prefs {
    ...
    my %pref_install = (
        ...
        'AnnoCPAN.yml'                => 'PerlOnJava/CpanDistroprefs/AnnoCPAN.yml',
        ...
        'Char-Latin2.yml'               => 'PerlOnJava/CpanDistroprefs/Char-Latin2.yml',
        'Char-Latin7.yml'               => 'PerlOnJava/CpanDistroprefs/Char-Latin7.yml',
        'Char-Windows1258.yml'           => 'PerlOnJava/CpanDistroprefs/Char-Windows1258.yml',
        'MooseX-BetterAnonNames.yml'     => 'PerlOnJava/CpanDistroprefs/MooseX-BetterAnonNames.yml',
...
sub _bootstrap_patches {
    ...
    my @bundled = (
        ...
        [ 'AnnoCPAN/SkipForkDatabaseTests.patch',
          'PerlOnJava/CpanPatches/AnnoCPAN-0.22/SkipForkDatabaseTests.patch' ],
        ...
        [ 'Char-Latin2/PerlOnJavaExecutable.patch',
          'PerlOnJava/CpanPatches/Char-Latin2-1.15/PerlOnJavaExecutable.patch' ],
        [ 'Char-Latin7/PerlOnJavaExecutable.patch',
          'PerlOnJava/CpanPatches/Char-Latin7-1.15/PerlOnJavaExecutable.patch' ],
        [ 'Char-Windows1258/PerlOnJavaExecutable.patch',
          'PerlOnJava/CpanPatches/Char-Windows1258-1.15/PerlOnJavaExecutable.patch' ],
        [ 'MooseX-BetterAnonNames/NoAutobox.patch',
