...
";
    ...
    # PerlOnJava doesn't support filehandle duplication, use BSD path
    my $is_perlonjava = defined $ENV{PERLONJAVA_EXECUTABLE};

    unless ($Is{BSD} || $is_perlonjava) {
...
WARNING
    ...
    foreach my $name (@$names){
        ...
        foreach my $dir ($use_dir ? @$dirs : 1){
            ...
            # PerlOnJava also uses this path since it doesn't support >&.
            if ($Is{BSD} || $is_perlonjava) {
