...
public class EmitSubroutine {
    ...
    public static void emitSubroutine(EmitterContext ctx, SubroutineNode node) {
        ...
        // Do NOT retain generated anonymous-sub classes in a global map.
        // For very large refactored modules (e.g. ExifTool), this can retain thousands of
        // Class objects until compilation completes and trigger OOM. The generated bytecode
        // already references the class directly.
