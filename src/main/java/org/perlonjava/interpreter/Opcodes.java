...
public class Opcodes {
    ...
    private static final short LASTOP = 234;
    ...
    public static final short ATAN2 = LASTOP + 1;
    public static final short BINARY_AND = LASTOP + 2;
    public static final short BINARY_OR = LASTOP + 3;
    public static final short BINARY_XOR = LASTOP + 4;
    public static final short EQ = LASTOP + 5;
    public static final short NE = LASTOP + 6;
    public static final short LT = LASTOP + 7;
    public static final short LE = LASTOP + 8;
    public static final short GT = LASTOP + 9;
    public static final short GE = LASTOP + 10;
    public static final short CMP = LASTOP + 11;
    public static final short X = LASTOP + 12;

    // scalar unary operations (chr, ord, abs, sin, cos, lc, uc, etc.)
    public static final short INT = LASTOP + 13;
    public static final short LOG = LASTOP + 14;
    public static final short SQRT = LASTOP + 15;
    public static final short COS = LASTOP + 16;
    public static final short SIN = LASTOP + 17;
    public static final short EXP = LASTOP + 18;
    public static final short ABS = LASTOP + 19;
    public static final short BINARY_NOT = LASTOP + 20;
    public static final short INTEGER_BITWISE_NOT = LASTOP + 21;
    public static final short ORD = LASTOP + 22;
    public static final short ORD_BYTES = LASTOP + 23;
    public static final short OCT = LASTOP + 24;
    public static final short HEX = LASTOP + 25;
    public static final short SRAND = LASTOP + 26;
    public static final short CHR = LASTOP + 27;
    public static final short CHR_BYTES = LASTOP + 28;
    public static final short LENGTH_BYTES = LASTOP + 29;
    public static final short QUOTEMETA = LASTOP + 30;
    public static final short FC = LASTOP + 31;
    public static final short LC = LASTOP + 32;
    public static final short LCFIRST = LASTOP + 33;
    public static final short UC = LASTOP + 34;
    public static final short UCFIRST = LASTOP + 35;
    public static final short SLEEP = LASTOP + 36;
    public static final short TELL = LASTOP + 37;
    public static final short RMDIR = LASTOP + 38;
    public static final short CLOSEDIR = LASTOP + 39;
    public static final short REWINDDIR = LASTOP + 40;
