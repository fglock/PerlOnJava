...
public class EmitFormat {
    ...
    public static void emitFormat(EmitterVisitor emitterVisitor, FormatNode node) {
        ...
        mv.visitMethodInsn(Opcodes.INVOKESTATIC, "org/perlonjava/runtime/runtimetypes/GlobalVariable",
                "getGlobalFormatRef", "(Ljava/lang/String;)Lorg/perlonjava/runtime/runtimetypes/RuntimeFormat;", false);
        ...
        mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "org/perlonjava/runtime/runtimetypes/RuntimeFormat",
                "setTemplate", "(Ljava/lang/String;)Lorg/perlonjava/runtime/runtimetypes/RuntimeFormat;", false);
