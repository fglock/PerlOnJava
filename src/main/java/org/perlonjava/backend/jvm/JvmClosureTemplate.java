...
public class JvmClosureTemplate {
    ...
    /**
     * Perl attributes (e.g., "method", "lvalue"), or null
     */
    ...
    public JvmClosureTemplate(Class<?> generatedClass, String prototype, String packageName) {
        this(generatedClass, prototype, packageName, null);
    }

    /**
     * Creates a JvmClosureTemplate for a generated class with attributes.
     *
     * @param generatedClass the JVM class implementing PerlSubroutine
     * @param prototype      Perl prototype string, or null
     * @param packageName    package where the sub was compiled
     * @param attributes     Perl attributes list, or null
     */
    public JvmClosureTemplate(Class<?> generatedClass, String prototype, String packageName, List<String> attributes) {
    ...
    public RuntimeScalar instantiate(RuntimeBase[] capturedVars) {
        try {
            ...
            if (attributes != null && !attributes.isEmpty()) {
                code.attributes = new java.util.ArrayList<>(attributes);
            }
