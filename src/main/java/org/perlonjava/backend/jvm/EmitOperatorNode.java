    ...
    public static void emitOperatorNode(EmitterVisitor emitterVisitor, OperatorNode node) {
        ...
        switch (node.operator) {
            ...
            case "unaryMinus" -> {
                ...
                // Emit a negative integer as its cached immutable literal instead
                // of dispatching through the general unary-overload path.
                // Non-integer and out-of-range literals retain the generic path.
