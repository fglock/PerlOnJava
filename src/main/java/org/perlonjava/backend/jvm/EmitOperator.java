...
public class EmitOperator {
    ...
    static void handleSubstr(EmitterVisitor emitterVisitor, BinaryOperatorNode node) {
        ...
        if (node.operator.equals("sprintf") && isBytes) {
            emitterVisitor.ctx.mv.visitMethodInsn(
                    Opcodes.INVOKESTATIC,
                    "org/perlonjava/runtime/operators/SprintfOperator",
                    "sprintfBytes",
    ...
    static void handleRepeat(EmitterVisitor emitterVisitor, BinaryOperatorNode node) {
        ...
        emitterVisitor.ctx.mv.visitMethodInsn(Opcodes.INVOKESTATIC, "org/perlonjava/runtime/operators/Operator",
                "repeat",
                "(Lorg/perlonjava/runtime/runtimetypes/RuntimeBase;Lorg/perlonjava/runtime/runtimetypes/RuntimeScalar;I)Lorg/perlonjava/runtime/runtimetypes/RuntimeBase;", false);
    ...
    static void handlePackageOperator(EmitterVisitor emitterVisitor, OperatorNode node) {
        ...
        // Also required for caller() from package DB to detect it's in DB:
    ...
    static void emitUndef(MethodVisitor mv) {
        mv.visitMethodInsn(Opcodes.INVOKESTATIC, "org/perlonjava/runtime/operators/Operator", "undef", "()Lorg/perlonjava/runtime/runtimetypes/RuntimeScalar;", false);
    }
