...
import org.perlonjava.runtime.operators.FormatModifierValidator;
...
public class PackParser {
     ...
     */
    private static void addDummyValuesForTemplate(String template, RuntimeList args) {
        int i = 0;
            ...
            for (int j = 0; j < valuesToAdd; j++) {
                switch (format) {
                    case 'a', 'A', 'Z' -> {
                        ...
                        args.add(new RuntimeScalar("test"));
                    }
                    case 'p', 'P' -> {
                        // Pointer formats - provide a string
                        args.add(new RuntimeScalar("pointer"));
                    }
                    case 'x', 'X', '@' -> {
                    ...
                    case 'U', 'W' -> {
                        ...
                        args.add(new RuntimeScalar(0x1FFC));
                    }
                    default -> {
                        // Numeric formats - provide a number
                        args.add(new RuntimeScalar(0));
                    }
                }
            }
        }
