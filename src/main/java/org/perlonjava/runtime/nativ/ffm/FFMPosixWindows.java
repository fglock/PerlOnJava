...
public class FFMPosixWindows implements FFMPosixInterface {
    ...
    public String strerror(int errno) {
        ...
        return switch (errno) {
            ...
            // Winsock errno values (WSABASEERR + offset)
            case 100 -> "Address already in use";
            case 101 -> "Address not available";
            ...
            case 112 -> "Operation in progress";
            case 113 -> "Socket is connected";
            case 114 -> "Too many levels of symbolic links";
            case 115 -> "Message too long";
            case 116 -> "Network is down";
            case 117 -> "Network unreachable";
            case 118 -> "Network dropped connection on reset";
            case 119 -> "No buffer space available";
            case 120 -> "No message available";
            case 121 -> "No protocol option";
            case 122 -> "Not connected";
            case 123 -> "State not recoverable";
            case 124 -> "Not a socket";
            case 125 -> "Not supported";
            case 126 -> "Operation not supported";
            case 127 -> "Value too large for defined data type";
            case 128 -> "Owner died";
            case 129 -> "Protocol error";
            case 130 -> "Protocol not supported";
            case 131 -> "Protocol wrong type for socket";
            case 132 -> "Timer expired";
            case 133 -> "Connection timed out";
            case 134 -> "Text file busy";
            case 135 -> "Operation would block";
            case 136 -> "Too many references";
            case 137 -> "Socket type not supported";
            case 138 -> "Protocol family not supported";
            case 139 -> "Host is down";
            case 140 -> "Too many users";
            case 141 -> "Disk quota exceeded";
            case 142 -> "Stale file handle";
            case 143 -> "Object is remote";
