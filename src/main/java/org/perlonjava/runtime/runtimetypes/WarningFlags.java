...
public class WarningFlags {
    ...
    static {
        ...
        offsets.put("experimental::alpha_assertions", 52);  // Historical no-op compatibility category
        offsets.put("experimental::isa", 52);  // Compatibility alias retained after isa became stable
        ...
        offsets.put("experimental::equ", 81);
