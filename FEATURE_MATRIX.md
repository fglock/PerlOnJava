...
- ✔️   **Bitwise operators**: Bitwise operations like `&`, `|`, `^`, `<<`, and `>>` are supported. Bitwise operations are always numeric.
- ❌  **Bitwise operators**: Bitwise string operations are not implemented.
