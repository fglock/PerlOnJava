...
- ✔️   These DBI methods are implemented: `connect`, `prepare`, `execute`, `fetchrow_arrayref`, `fetchrow_array`, `fetchrow_hashref`, `rows`, `disconnect`, `err`, `errstr`, `state`, `do`, `finish`, `last_insert_id`.
