...
print "not " if $1 ne 'Hello'; say "ok # \$1 is 'Hello'";
print "not " if $2 ne 'World'; say "ok # \$2 is 'World'";
...
print "not " if scalar(@matches) != 2; say "ok # 'Hello World' matches '(Hello) (World)' in list context";
