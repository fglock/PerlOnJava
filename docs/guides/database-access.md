...
2. Using Java classpath:
   ...
   Windows:
    ...
    ```bash
    java --enable-native-access=ALL-UNNAMED --sun-misc-unsafe-memory-access=allow -cp "jdbc-drivers/h2-2.2.224.jar:target/perlonjava-3.0.0.jar" org.perlonjava.app.cli.Main myscript.pl
    ```
